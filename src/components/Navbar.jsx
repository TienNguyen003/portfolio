  ...
  return (
    <>
      ...
      <nav ref={navRef} className="w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50">
        ...
        >
          <li>
            <a className="hover:text-gray-500 dark:hover:text-gray-300 transition" href="#top">
              {t("nav.home")}
            </a>
          </li>
          <li>
            <a className="hover:text-gray-500 dark:hover:text-gray-300 transition" href="#about">
              {t("nav.aboutMe")}
            </a>
          </li>
          <li>
            <a className="hover:text-gray-500 dark:hover:text-gray-300 transition" href="#services">
              {t("nav.services")}
            </a>
          </li>
          <li>
            <a className="hover:text-gray-500 dark:hover:text-gray-300 transition" href="#work">
              {t("nav.myWork")}
            </a>
          </li>
          <li>
            <a className="hover:text-gray-500 dark:hover:text-gray-300 transition" href="#journey">
              {t("nav.myJourney")}
            </a>
          </li>
          <li>
            <a className="hover:text-gray-500 dark:hover:text-gray-300 transition" href="#contact">
              {t("nav.contactMe")}
            </a>
          </li>
        </ul>
        ...
        <div className="flex items-center gap-4">
          <button
            ...
            className="px-3 py-1.5 text-sm font-semibold rounded-full border border-gray-300 dark:border-white/30 hover:bg-slate-100/70 dark:hover:bg-darkHover transition"
          >
            {language === "en" ? "VI" : "EN"}
          </button>
